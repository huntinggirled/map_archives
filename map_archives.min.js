...
h.thumbnail+'" height="45" width="45" alt="'+h.thumbnail+'" title="'+r+'" /></a>'),q=q+('<a href="'+h.link+'" target="_blank" title="'+r+'">'+h.title+"</a><br />"),q=q+"</div>";!l||"0-0"!=l&&"4-4"!=l&&"1-1"!=l&&l!=p&&"3-3"!=l||(p=new google.maps.LatLng(h.lat,h.lng),d||(d=p),"3-3"==l?f.lat()==p.lat()&&f.lng()==p.lng()&&(a.createMarker(p,r,q,k++),1!=k||g||(a("title").append(": "+h.title),a(".archive-header").append(": "+h.title))):"0-0"==l&&10<=e||"4-4"==l&&100<=e||a.createMarker(p,r,q,k++))}m.panTo(d);
a(this).focus();if(!g){"3-3"==l&&0<k-1&&(a("title").append(" \u4ed6"+(k-1)+"\u4ef6"),a(".archive-header").append(" \u4ed6"+(k-1)+"\u4ef6"));var c="",d=0,n;for(n in b)e=n.replace("-0","-"),c+='<option value="'+n+'">'+e.split("-")[0]+"\u5e74"+e.split("-")[1]+"\u6708\uff08"+b[n]+"\uff09</option>",d+=b[n];g="";g+='<select onchange="$(this).markerToggle(this[this.selectedIndex].value);return false;">';f&&(g+='<option value="3-3">\u30ea\u30f3\u30af\u5730\u70b9</option>');g+='<option value="0-0">\u76f4\u8fd110\u4ef6</option>';
g+='<option value="4-4">\u76f4\u8fd1100\u4ef6</option>';g+=c;g+='<option value="1-1">\u5168\u30de\u30fc\u30af\uff08'+d+'\uff09</option><option value="2-2">\u5168\u3066\u524a\u9664</option></select>';a("#marker_div").empty().append(g)}l&&"3-3"==l?(f&&a.directMarker(f),a("#sort_div").hide("fast"),a("#search_div").hide("fast"),a("#polyline_div").hide("fast")):(a("#sort_div").show("fast"),a("#search_div").show("fast"),a("#polyline_div").show("fast"))};a.createMarker=function(c,b,f,g){var e=new google.maps.Marker({position:c,
map:m,title:b,zIndex:g}),k=new google.maps.InfoWindow({content:f,zIndex:1E4});google.maps.event.addListener(e,"click",function(){s.close();if(n.getPosition()&&n.getPosition().equals(e.getPosition())&&n.getPosition().equals(e.getPosition()))return n=new google.maps.Marker,!1;k.open(m,e);s=k;n=e;a("#marker_div select").blur()});a("#polyline").is(":checked")&&t.getPath().insertAt(y++,c);d.push(e);u.push(k)};a.fn.sortToggle=function(){a("#sort1").is(":checked")?(a("#sort2").prop("checked",!0),a("#search_button").attr("disabled",
...
a.fn.screenToggle=function(){if(a("#screen").is(":checked")){var c=m.getCenter();f.css("position","fixed");f.css("top","0px");f.css("left","0px");f.css("width","100%");f.css("height","100%")}else c=m.getCenter(),f.css("position","relative"),f.css("width",v.width),f.css("height",v.height);google.maps.event.trigger(m,"resize");m.panTo(c)};a.fn.tabToggle=function(){"0px"==a("#screennavi").css("right")?(a("#screennavi").animate({right:"-"+(a("#screennavi").width()-50)+"px",bottom:"-"+(a("#screennavi").height()-
17)+"px"},200),a("#navitab a").text("\u25c6 \u958b\u304f")):(a("#screennavi").animate({right:"0px",bottom:"0px"},200),a("#navitab a").text("\u25c7 \u9589\u3058\u308b"))};a.fn.slideMarker=function(a){var b=d.getAt(0).getZIndex(),f=d.getAt(d.length-1).getZIndex();a<b?a=f:f<a&&(a=b);for(b=0;b<d.length;b++)if(d.getAt(b).getZIndex()==a){s.close();a=d.getAt(b);b=u.getAt(b);b.open(m,a);m.panTo(a.getPosition());s=b;n=a;break}};a.directMarker=function(a){for(var b=0;b<d.length;b++)if(d.getAt(b).getPosition().lat()==
a.lat()&&d.getAt(b).getPosition().lng()==a.lng()){s.close();a=d.getAt(b);b=u.getAt(b);b.open(m,a);m.panTo(a.getPosition());s=b;n=a;break}};a.fn.getCurrentPosition=function(){a("#current_button").attr("disabled",!0);a("#current_div").append(' <img src="img/indi.gif" alt="\u8aad\u307f\u8fbc\u307f\u4e2d..." width="10" height="10" />');navigator.geolocation?navigator.geolocation.getCurrentPosition(function(c){c=new google.maps.LatLng(c.coords.latitude,c.coords.longitude);m.panTo(c);a("#current_button").attr("disabled",
